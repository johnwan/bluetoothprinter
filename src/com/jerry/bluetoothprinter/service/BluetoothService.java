...
public class BluetoothService {    
    ...
    private void addBondDevicesToListView() {    
        ...
        System.out.println("Bonded Devices number: " + count);    
    ...
    private void addUnbondDevicesToListView() {    
        ...
        System.out.println("unbonded Devices number: " + count);    
        for (int i = 0; i < count; i++) {    
            HashMap<String, Object> map = new HashMap<String, Object>();    
                ...
                .setOnItemClickListener(new OnItemClickListener() {    
                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1,    
                        ...
                        try {    
                            ...
                            Toast.makeText(context, "Pair failed", Toast.LENGTH_SHORT)    
                                    .show();    
                        }    
    ...
    public void addUnbondDevices(BluetoothDevice device) {    
        System.out.println("Unbonded Devices' Name:" + device.getName());    
    ...
    public void addBandDevices(BluetoothDevice device) {    
        System.out.println("Bonded Devices' name = " + device.getName());    
        ...
        public void onReceive(Context context, Intent intent) {    
            ...
            if (BluetoothAdapter.ACTION_STATE_CHANGED.equals(action)) {    
                if (bluetoothAdapter.getState() == BluetoothAdapter.STATE_ON) {    
                    ...
                    System.out.println("--------Turn Off Bluetooth-----------");    
                    switchBT.setText("Turn On Bluetooth");    
